...
<script type="text/javascript">
	$(function() {
		$('#ab').ready(function() {
			$('#menus').html(
				"<div align='center' width='800px'><font size='20px'>이용수칙</font><br><hr width='800px'><img src='images/sub.jpg'></div>");
				});
		$('#ab').click(function() {
			$('#menus').html(
...
<body>
	<div class="container-fluid" id="headbg" align="center"	style="padding-top: 50pt">
		<div class="row">
	...
	<div class="container-fluid">
		<nav class="navbar navbar-expand-sm bg justify-content" style="background-color: #2F3E46; margin-left: -15px; margin-right: -15px;">
			<ul class="navbar-nav">
	...
	<div style="padding-bottom: 50px; margin-top:-20px;">
		<div class="container" style="margin-left: 0px; height: 100%;">
			<div class="row">
				<div class="col-sm-3" style="background-color: #26A65B;">
					<!-- carousel시작 -->
					<h2>새로운 소식</h2>
					...
					<!-- 왼쪽 메뉴바 내용 -->
					<h3>
						<button id="ab" class="btn btn-primary btn-block" style="background-color: #2F3E46;">메인</button>
					</h3>
					<h3>
					...
					</h3><%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
