...
public class GuestReplyDelete extends HttpServlet {
	...
	public void doUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("GuestReplyDelete.jsp = greplyDelete.tis  �̵�");
		ReplyDTO  rdto = new ReplyDTO();
		ReplySQL  rsql = new ReplySQL();
			
//<a href="greplyDelete.tis?Gnum=${rdto.num}&Gidx=${rsabun}">[����]<a>
		int rsabun=Integer.parseInt(request.getParameter("Gidx"));
		System.out.println("�������greplyDelete.tis  Gidx=" + rsabun);
		int rnum=Integer.parseInt(request.getParameter("Gnum"));
		System.out.println("�������greplyDelete.tis  Gnum=" + rnum);
